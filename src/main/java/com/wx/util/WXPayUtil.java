...
import com.wx.entity.UnifiedOrderRequest;
import com.wx.entity.UnifiedOrderRespose;
...
public class WXPayUtil {
    ...
    public static Map<String,Object> createOrderInfo(Map<String, String> requestMap) {
        ...
        unifiedOrderRequest.setNonce_str(requestMap.get("nonce_str"));//随机字符串
        ...
        try {
            unifiedOrderRequest.setSign(generateSignature(packageParams,"你的密匙"));//签名  ,此处第二个参数填写秘钥
        } catch (Exception e) {
            e.printStackTrace();
        }
        //将订单对象转为xml格式
    ...
    public static Map<String,String> getMaptoOrder(PaymentOrder porder){
        ...
        map.put("signType", porder.getSingType());
